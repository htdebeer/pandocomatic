...
You can also download the latest gem [pandocomatic-0.1.4](https://github.com/htdebeer/pandocomatic/blob/master/releases/pandocomatic-0.1.4.gem) from github and install it as follows:
