...
[pandocomatic-1.1.2](https://github.com/htdebeer/pandocomatic/blob/master/releases/pandocomatic-1.1.2.gem),
from Github and install it manually as follows:

``` bash
cd /directory/you/downloaded/the/gem/to
gem install pandocomatic-1.1.2.gem
```
...
2.  Then pandocomatic mixes in the configuration files named
    ...
    1.  The configuration file in the *pandocomatic data directory*
        specified on the command line with option "--data-dir" or "-d".\
    2.  The configuration file in the *pandoc data directory*, if it
...
and finally by the configuration specified with the `--config` option.
