...
You can also download the latest [gem](https://rubygems.org/) [pandocomatic-0.1.4.18](https://github.com/htdebeer/pandocomatic/blob/master/releases/pandocomatic-0.1.4.18.gem) from [Github](https://github.com) and install it manually as follows:
