...
You can also download the latest [gem](https://rubygems.org/) [pandocomatic-0.2.0.4](https://github.com/htdebeer/pandocomatic/blob/master/releases/pandocomatic-0.2.0.4.gem) from [Github](https://github.com) and install it manually as follows:

``` bash
cd /directory/you/downloaded/the/gem/to
gem install pandocomatic-0.2.0.4.gem
```
